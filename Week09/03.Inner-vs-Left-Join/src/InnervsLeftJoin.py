...
# # 03.Inner-vs-Left-Join
#
# [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/vuhung16au/ACU-ITEC102/blob/main/Week09/03.Inner-vs-Left-Join/notebooks/01_03.Inner-vs-Left-Join.ipynb)
#
# ## Overview
#
# This notebook explores the concepts of 03.Inner vs Left Join.
#
